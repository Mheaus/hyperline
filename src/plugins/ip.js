...
function getIp() {
  ...
  Object.keys(ifaces).forEach(function readIfaces(ifname) {
    ifaces[ifname].forEach(function findIpAddress(iface) {
      if (iface.family === 'IPv4' && iface.internal === false && localIp === '') {
